...
var properties = [{
	...
	{
		value: "lastCommentComment",
		label: "lastCommentComment",
		table: {
			visible: true,
			sortable: true
		},
		...
		value: "lastCommentTimestamp",
		label: "last Commenter Timestamp",
		table: {
			visible: true,
			sortable: true
		},
		...
		value: "lastCommentUserName",
		label: "Last Commenter Username",
		table: {
			visible: true,
			sortable: true
		},
		...
		value: "lastCommentUserID",
		label: "lastComment UserID",
		table: {
			visible: true,
			sortable: true
		},
...
var mapbox = L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFuaW5nIiwiYSI6IlhjWGNfdTQifQ.ras0nImWG638BCDSxU8bqw', {
	maxZoom: 19,
	id: 'mapbox.streets',
